"""Lambda entrypoint for api-profiles."""
...
_logger = StructuredLogger(service="api-profiles")
...
def lambda_handler(event: dict, context) -> dict:
    ...
    _logger.info("request_received", route_key=route_key)
    ...
    try:
        ...
        _logger.error("unhandled_error", error=str(exc))
        return error_response(
            500,
            "INTERNAL_ERROR",
            "Unexpected error",
